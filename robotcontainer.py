...
from commands.transfer.run_transfer_motors import (
    RunTransferCommand,
...
class RobotContainer:
    ...
    def configureButtonBindings(self) -> None:
        ...
        self._controller_1.povUp().onTrue(OverrideRotation(self._drivetrain))
        self._controller_1.povLeft().onTrue(SetOdometryBackLeft(self._drivetrain))
        self._controller_1.povRight().onTrue(SetOdometryBackRight(self._drivetrain))
