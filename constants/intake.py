...
class kIntakePivot:
    ...
    _CONFIG.motion_magic.motion_magic_cruise_velocity = 100  # rotations/sec
    _CONFIG.motion_magic.motion_magic_acceleration = 300     # rotations/sec²
    _CONFIG.motion_magic.motion_magic_jerk = 250             # rotations/sec³
