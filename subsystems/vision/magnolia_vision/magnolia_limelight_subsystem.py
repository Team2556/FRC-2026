...
class Vision(commands2.Subsystem):
    ...
    def get_best_measurement(self, estimates: list[magnolia_limelight_helpers.PoseEstimate]):
        if not estimates:
            return None
    ...
    def get_vision_odometry(
        ...
        for camera in self._cameras:
            magnolia_limelight_helpers.set_robot_orientation(camera, headingDeg, 0, 0, 0, 0, 0)
            limelight_measurement = magnolia_limelight_helpers.get_bot_pose_estimate(
